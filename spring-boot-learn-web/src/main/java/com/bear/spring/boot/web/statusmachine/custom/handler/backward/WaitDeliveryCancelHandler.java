...
@Service
@Slf4j
public class WaitDeliveryCancelHandler implements Handler<OrderStatusEnum> {
    ...
    public void handle(StatusMachineDomain<OrderStatusEnum> domain, OrderStatusEnum orderStatus) {
        ...
        log.info("状态机处理->待发货取消 orderNo:{} === {} --> {}", tgOrderMachine.getOrderNo(), domain.getCurrentStatus().toString(), orderStatus.toString());
        // TODO 处理核销逻辑
