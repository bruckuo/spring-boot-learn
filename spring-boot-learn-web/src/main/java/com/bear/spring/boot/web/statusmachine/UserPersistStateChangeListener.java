...
@Component
@Slf4j
public class UserPersistStateChangeListener implements PersistStateMachineHandler.PersistStateChangeListener {
    ...
    public void onPersist(State<OrderStatusEnum, OrderEventEnum> state, Message<OrderEventEnum> message, Transition<OrderStatusEnum, OrderEventEnum> transition, StateMachine<OrderStatusEnum, OrderEventEnum> stateMachine) {
        ...
        System.out.println("UserPersistStateChangeListener============>:"+ transition.getSource().getId().name());
        System.out.println("UserPersistStateChangeListener============>:"+ transition.getTarget().getId().name());
    }
}